...
function SelectedMovie({ watched, selectedID, onCloseMovie, movieWatched }) {
...
function WatchedMovieList({ watched, removeWatchedMovie }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovie
